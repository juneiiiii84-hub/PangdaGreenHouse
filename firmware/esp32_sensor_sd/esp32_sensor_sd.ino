...
float calibrateLux(float rawLux) {
  ...
  if (rawLux < 432.0) {
    ...
    // ปรับสเกลช่วงแดดจ้าทั้งหมดแบบเกลี่ยเส้นตรง (Smoothed High-Light Regression):
    // จูนจากจุดเริ่มต้น 2,880.5 Lux (ดิบ 1,964.58) ไปจนถึงระดับสูงสุด 36,983.0 Lux (ดิบ 20,384.25)
    // Slope = (36983.0 - 2880.5) / (20384.25 - 1964.58) = 1.8514
    return 1.8514 * (rawLux - 1964.58) + 2880.5;
  }
}
