...
const getGreenhouseSummary = (avg: any) => {
  ...
  let lightText = '';
  if (lux > 43200) lightText = '☀️ แสงสว่าง: แดดแรงจ้าเกินไป (ควรดึงสแลนกรองแสงมาช่วยบดบัง)';
  else if (lux >= 21600) lightText = '☀️ แสงสว่าง: แสงแดดส่องสว่างดีเยี่ยม พืชสังเคราะห์แสงสร้างอาหารได้เต็มที่';
  else if (lux >= 10800) lightText = '☀️ แสงสว่าง: แสงค่อนข้างสลัว (พืชจะสังเคราะห์อาหารช้าลง)';
  else lightText = '☀️ แสงสว่าง: แสงสลัวเกินไป (หากฟ้าครึ้มควรเปิดไฟช่วยปลูกเสริมแสงสว่าง)';
